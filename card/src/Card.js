...
const Card = () => {
  return (
    <div className="max-w-lg mx-auto border border-black bg-blue-100 rounded-xl overflow-hidden shadow-lg relative transform hover:scale-105 transition-transform">
      <div className="flex flex-col sm:flex-row p-2">
        ...
        <div className="w-full sm:w-2/3 p-4 pr-6">
          <p className="text-orange-500 text-center w-fit px-2 rounded bg-white text-base font-semibold mb-1">
            After Effects
          </p>
